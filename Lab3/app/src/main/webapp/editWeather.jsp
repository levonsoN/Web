...
<form method="POST">
    ...
    <br>
    <button name="submit" type="submit" style="margin: 10px;">Edit Weather Data</button>
</form>
<p>
    <%
        ...
        if (request.getParameter("submit") != null) {
            try {
                ...
                int rowsAffected = DbHandler.updateWeatherData(regions[regionIndex], date, temperature, precipitation);
                if (rowsAffected > 0)
                    out.println("Weather data has been updated successfully");
            } catch (Exception ex) {
